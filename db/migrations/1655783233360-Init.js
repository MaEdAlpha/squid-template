module.exports = class Init1655783233360 {
  name = 'Init1655783233360'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "base" ("id" character varying NOT NULL, "block" integer NOT NULL, "symbol" text NOT NULL, "type" text, "issuer" text NOT NULL, "parts" jsonb NOT NULL, CONSTRAINT "PK_ee39d2f844e458c187af0e5383f" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "properties" ("id" character varying NOT NULL, "royalty_info" text NOT NULL, "attributes" text, "rarity" text, "race" text, "rootowner" text, CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`)
  }
